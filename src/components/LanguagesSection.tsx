    ...
    <Card className="bg-cv-content border-border/50 p-4 shadow-lg hover:shadow-xl transition-all duration-300">
      <Popover>
        <PopoverTrigger asChild>
          <div className="flex items-center justify-center space-x-3 cursor-pointer hover:bg-cv-accent/5 p-2 rounded-lg transition-all duration-200 group">
            <Languages className="w-5 h-5 text-cv-accent group-hover:scale-110 transition-transform" />
            <h3 className="text-lg font-semibold text-cv-content-foreground">Idiomas</h3>
